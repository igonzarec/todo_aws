...
class Todo extends Model {
  ...
  const Todo._internal({required this.id, required title, isComplete, required userId, createdAt, updatedAt}): _title = title, _isComplete = isComplete, _userId = userId, _createdAt = createdAt, _updatedAt = updatedAt;
